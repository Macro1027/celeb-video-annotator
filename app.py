...
import pandas as pd
from utils import load_config, validate_config, ensure_directory
from load_data import get_available_faces
...
def main():
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python app.py --create-database --generate-video --export-timeline
  python app.py --create-database
  python app.py --generate-video --export-timeline
  python app.py --generate-video --no-export-timeline
        """
    )
